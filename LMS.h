        ...
        while(getline(ifile,line))
		    {
		        ...
		        if(name == bookName)
		        {
		            cout<<"Record successfully deleted from database"<<endl;
		            cout<<line<<endl;
		            flag++;
		        }
		        else
...
class returnBook:public addbooks
{
    private:
         int books_count,book_id;
        ...
        void delete_bookId(int book_id)
        {
	        ...
	        while(getline(ifile,line))
		    {
		      ...
		      if(id == book_id)
		      {
		          cout<<"Record successfully deleted from issued_books"<<endl;
		          cout<<line<<endl;
		          flag++;
		      }
		      else
    ...
    public:
        returnBook()
        {
            cout<<"Enter the Book Issued Day: ";
            cin>>d;
            cout<<"Enter the Book Issued month: ";
            cin>>m;
            cout<<"Enter the Book Issued Year: ";
            cin>>y;
            Day=d;
            Month=m;
            Year=y;
        ...
        void Return()
        {
            ...
            cout<<"----------------------------------------------------"<<endl;
            cout<<"1. If Current Date is Between the Issue Date And Return Date then NO Penality"<<endl;
            cout<<"2. If Current Date Is more then Return Date Penalty is added: "<<endl;
            int choice;
            cout<<"Enter Choice: ";
            cin>>choice;
            switch(choice)
            {
                ...
                ofstream fout;
                //fout.open("Issued_books.txt",ios::app);
                ...
                insert_books();
                fout.close();
                cout<<"Issued book returned successfully"<<endl;
...
class student:public Delete{
    ...
    {
        fstream file;
        file.open("Issued_books.txt",ios::out|ios::app);
    ...
    void search_bookId(int book_id)
		{
		    ...
		    while(getline(file,line))
		    {
		        ...
		        if(id == book_id)
		        {
		            cout<<"\nBook_ID   Book_name    student_id  student_name    branch"<<endl;
		            cout<<line<<endl;
		            flag++;
		        }
		    }
